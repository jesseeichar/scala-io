...
class GlobParserTest {
  ...
  def testGlobToRegEx :Unit = {
    ...
    compareGlob("hi"+sep+"o**k","\\Qhi\\E"+sep+"\\Qo\\E"+noSep+"*"+noSep+"*\\Qk\\E")
    compareGlob("hi"+sep+"o\\?","\\Qhi\\E"+sep+"\\Qo\\E\\?")
    compareGlob("hi"+sep+"o\\"+sep+"hi"+sep,"\\Qhi\\E"+sep+"\\Qo\\E\\"+sep+"\\Qhi\\E"+sep)
    compareGlob("th.s/\\\\ws/","\\Qth.s\\E/\\\\\\Qws\\E/")
    compareGlob("hi"+sep+"**"+sep+"[a-b]*.{scala,java}","\\Qhi\\E"+sep+".*"+sep+"[a-b]"+noSep+"*\\Q.\\E(\\Qscala\\E|\\Qjava\\E)")
